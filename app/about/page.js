        ...
        <>
            <div className=" relative w-full min-h-screen flex flex-col justify-center overflow-hidden">
                <div className="absolute inset-0 -z-10">
                    {/* <Particles /> */}
                    <AnimatedGridPattern maxOpacity={0.2} />
                </div>
                <div className="container mx-auto px-4 md:px-6 lg:px-8 flex flex-col md:flex-row items-center">
                    <div className="w-full md:w-1/2 z-20 order-2 md:order-1 mt-10 md:mt-0">
                        ...
                        <MorphingText
                            ...
                            className="mt-6 text-cyan-400 text-xl sm:text-2xl md:text-3xl lg:text-4xl text-left"
                        />

                        <p className="text-gray-950  dark:text-gray-50  max-w-full md:max-w-[500px] text-left text-sm sm:text-base md:text-[1.1rem] font-sans">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 md:gap-8 mt-6 md:mt-10">
                            <PulsatingButton
                                className="rounded-full transition-transform duration-300 hover:-translate-y-1 hover:shadow-lg w-full sm:w-auto px-6 py-2 text-sm sm:text-base"
                            >
                                View My Work
                            </PulsatingButton>
